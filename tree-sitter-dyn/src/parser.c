...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(88),
  ...
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binexpr, 3),
  ...
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func, 5),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func, 4),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func, 4),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 4),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let, 4),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 5),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let, 5),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr, 1),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr, 1),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func, 2),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func, 2),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unaryexpr, 2),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unaryexpr, 2),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 1),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 1),
  ...
  [188] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_func_repeat1, 2), SHIFT_REPEAT(85),
